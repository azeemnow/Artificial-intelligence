...
| **Anti-Fatigue-Signal-Over-Noise**                | A response-style and decision-support skill that maximizes signal over noise,  leads with the answer (BLUF), matches depth and vocabulary to the actual question, reaches for visuals or decision razors only when they genuinely add clarity, and detects analysis-paralysis loops rather than feeding them. Built to leave people with a confident next action, not a longer conversation. | [Anti-Fatigue-Signal-Over-Noise](./Anti-Fatigue-Signal-Over-Noise)                   |
